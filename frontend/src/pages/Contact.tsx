...
export default function Contact() {
  ...
  return (
    <div className="bg-surface text-on-background font-body-md selection:bg-secondary/30 bg-gradient-to-br from-surface-container-low">
      <SiteHeader active="/contact" />

      <main className="pt-20 w-full flex flex-col">
        <header className="relative w-full min-h-[250px] md:h-[350px] flex items-center overflow-hidden bg-primary-container">
          <div className="absolute inset-0 opacity-10 map-texture"></div>
          <div className="relative z-10 px-margin-mobile md:px-margin-desktop py-lg max-w-4xl">
            <h1 className="font-display-lg text-display-lg-mobile md:text-display-lg text-white mb-sm">Get in Touch</h1>
            <p className="font-body-md md:font-body-lg text-body-md md:text-body-lg text-surface-variant max-w-2xl">
              We are here to serve and protect our community. Reach out to our 24/7 response unit or visit us during office hours.
            </p>
            <div className="mt-lg flex flex-wrap gap-sm md:gap-md">
        ...
        <section className="px-margin-mobile md:px-margin-desktop py-lg md:py-xl bg-background">
          <div className="flex flex-col gap-lg max-w-5xl mx-auto">
            <div className="w-full order-1">
              <div className="glass-card rounded-2xl p-md md:p-lg shadow-sm border border-outline-variant/50 !bg-white !border-t-2 transition-all hover:-translate-y-1 hover:shadow-lg">
                <div className="mb-md md:mb-lg">
                  <h2 className="font-headline-lg text-headline-lg-mobile md:text-headline-lg text-on-surface mb-xs">Send a Secure Message</h2>
                ...
                {sent ? (
                  <div className="space-y-md">
                    <div className="flex flex-col items-center text-center gap-sm py-md">
                      <span className="w-14 h-14 rounded-full bg-success-green/10 text-success-green flex items-center justify-center">
                      ...
                      <button
                        ...
                        className="px-lg py-md border border-outline-variant text-on-surface-variant font-label-md rounded-xl hover:bg-white transition-all"
                      >
                ...
                <form className="space-y-md md:space-y-md" onSubmit={submit}>
                  <div className="flex flex-col md:grid md:grid-cols-2 gap-md">
                    <div className="space-y-xs">
                      ...
                      <input className="w-full h-14 md:h-12 rounded-lg bg-white border border-outline-variant focus:border-secondary focus:ring-2 focus:ring-secondary/20 transition-all px-md" placeholder="Juan Dela Cruz" type="text" required value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} />
                    </div>
                    <div className="space-y-xs">
                      <label className="font-label-md text-label-md text-on-surface">Email Address</label>
                      <input className="w-full h-14 md:h-12 rounded-lg bg-white border border-outline-variant focus:border-secondary focus:ring-2 focus:ring-secondary/20 transition-all px-md" placeholder="juan@example.com" type="email" value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} />
                    </div>
                  </div>
                  <div className="space-y-xs">
                    <label className="font-label-md text-label-md text-on-surface">Phone Number</label>
                      <input className="w-full h-14 md:h-12 rounded-lg bg-white border border-outline-variant focus:border-secondary focus:ring-2 focus:ring-secondary/20 transition-all px-md" placeholder="+63 900 000 0000" type="tel" value={form.phone} onChange={(e) => setForm({ ...form, phone: e.target.value })} />
                  </div>
                  <div className="space-y-xs">
                    <label className="font-label-md text-label-md text-on-surface">Message</label>
                    <textarea className="w-full rounded-lg bg-white border border-outline-variant focus:border-secondary focus:ring-2 focus:ring-secondary/20 transition-all px-md py-md" placeholder="How can we assist you today?" rows={4} required value={form.message} onChange={(e) => setForm({ ...form, message: e.target.value })}></textarea>
                  </div>
                  {error && <p className="font-body-sm text-body-sm text-error-red">{error}</p>}
                  <button className="w-full md:w-auto px-lg py-4 md:py-md bg-secondary text-white font-label-md text-label-md rounded-xl shadow-md hover:shadow-lg active:scale-95 transition-all flex items-center justify-center gap-base disabled:opacity-50" type="submit" disabled={sending}>
            ...
            <div className="w-full space-y-lg order-2">
              <div className="space-y-md">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-md">
                  <div className="flex items-center gap-md p-md bg-white rounded-xl border border-outline-variant/30 shadow-sm border-t-2 border-secondary">
                  ...
                  <div className="flex items-center gap-md p-md bg-white rounded-xl border border-outline-variant/30 shadow-sm border-t-2 border-secondary">
                    ...
                    <div className="overflow-hidden">
                      ...
                      <p className="font-body-md text-body-md text-on-surface font-bold truncate">contact@lgu-enforcement.gov</p>
                    </div>
                  </div>
                </div>
              </div>
              <div className="space-y-md">
                ...
                <div className="p-md bg-white rounded-xl border border-outline-variant/30 shadow-sm space-y-sm">
              ...
              <div className="relative w-full h-56 md:h-64 rounded-2xl overflow-hidden shadow-sm border border-outline-variant/30 map-texture group">
                <div className="absolute inset-0 bg-secondary/5"></div>
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    <span className="material-symbols-outlined text-secondary text-5xl mb-xs drop-shadow-md animate-bounce">location_on</span>
        ...
        <section className="bg-surface-container-low py-lg md:py-xl border-y border-outline-variant/30">
          <div className="px-margin-mobile md:px-margin-desktop text-center max-w-3xl mx-auto">
            <span className="material-symbols-outlined text-secondary text-4xl md:text-5xl mb-md">verified</span>
            <h2 className="font-headline-lg text-headline-lg-mobile md:text-headline-lg text-on-surface mb-md">Integrity and Transparency</h2>
            ...
            <div className="flex flex-col md:flex-row justify-center gap-md">
              <button className="w-full md:w-auto px-lg py-md border-2 border-secondary text-secondary font-label-md rounded-xl hover:bg-secondary/5 transition-all">View FAQ</button>
              <button className="w-full md:w-auto px-lg py-md border-2 border-outline text-on-surface-variant font-label-md rounded-xl hover:bg-white transition-all">FOI Portal</button>
            </div>
          </div>
        </section>
      </main>
