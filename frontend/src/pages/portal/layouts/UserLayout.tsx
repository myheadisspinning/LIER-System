           ...
           <div className="p-4 pb-3 border-b border-outline-variant/30">
             <div className="flex items-center justify-between">
               <div className="flex items-center gap-2.5">
                 ...
                 <div>
                   <h1 className="text-sm font-bold text-on-surface leading-tight tracking-tight">{userNav.brand}</h1>
                   <p className="text-[8px] text-on-surface-variant uppercase tracking-widest font-bold mt-0.5">{userNav.brandSub}</p>
                 </div>
               </div>
              <button
                type="button"
