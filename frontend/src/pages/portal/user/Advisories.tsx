...
category === c
 ...
 {loading ? (
 <div className="bg-surface-container-lowest border border-border-subtle rounded-2xl p-6 sm:p-10 text-center text-sm text-on-surface-variant ">Loading advisories…</div>
 ) : advisories.length === 0 ? (
