...
<div className="flex space-x-1 bg-surface-container rounded-lg p-1 w-fit">
 ...
 <div className="bg-surface-container-lowest border border-border-subtle rounded-2xl p-4 sm:p-5 mb-6 sm:mb-8 flex flex-col lg:flex-row lg:items-center gap-4 sm:gap-5">
 ...
 <div className="fixed inset-0 bg-on-surface/80 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
  <div className="bg-surface-container-lowest w-full max-w-4xl rounded-lg flex flex-col border border-outline-variant max-h-[90vh]">
  ...
  <div className="w-full bg-on-surface aspect-video rounded-md border border-outline-variant flex items-center justify-center mb-6 relative ">
  {inspect.thumb ? (
