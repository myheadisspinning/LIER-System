...
const inputClass =
 'w-full pl-9 pr-3 py-1.5 sm:py-2 bg-surface-bg border border-border-subtle rounded-lg text-body-sm font-body-sm focus:border-secondary focus:ring-1 focus:ring-secondary outline-none transition-shadow';
...
export default function AccountSettings() {
 ...
 <>
  <div className="bg-surface-container-lowest border border-border-subtle rounded-2xl p-4 sm:p-6 flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6 mb-4 sm:mb-6 relative overflow-hidden text-center sm:text-left">
  ...
  <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-secondary text-on-secondary flex items-center justify-center font-headline-lg text-headline-lg border-4 border-surface-container-lowest overflow-hidden shrink-0">
  {profile.avatar_url ? (
  ...
  <button type="button" onClick={saveProfile} disabled={saving} className="px-4 py-2 border border-border-subtle hover:bg-surface-container text-on-surface font-label-md text-label-md rounded-lg transition-colors disabled:opacity-60">
  ...
  <div className="space-y-1">
   ...
   <input className="flex-1 w-full px-3 py-1.5 sm:py-2 bg-surface-bg border border-border-subtle rounded-r-lg text-body-sm font-body-sm focus:border-error-red focus:ring-1 focus:ring-error-red outline-none transition-shadow" placeholder="9XX XXX XXXX" type="tel" value={profile.emergency_contact_phone} onChange={(e) => setField('emergency_contact_phone', e.target.value)} />
   </div>
  </div>
  </div>
  ...
  disabled={saving}
  className="w-full sm:w-auto bg-gradient-to-r from-secondary to-[#316bf3] hover:opacity-90 text-on-secondary font-label-md text-label-md py-3 px-8 rounded-lg transition-all duration-200 active:scale-[0.98] disabled:opacity-60"
  >
